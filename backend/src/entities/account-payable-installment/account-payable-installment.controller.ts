...
export class AccountPayableInstallmentController {
    constructor(private readonly accountPayableInstallmentService: AccountPayableInstallmentService) { }

    @Post('/')
    async createAccountPayableInstallment(@Body() body: CreateAccountPayableInstallmentDTO) {
    ...
    @Put('/:id')
    async updateAccountPayableInstallment(@Param('id') id: string, @Body() body: UpdateAccountPayableInstallmentDTO) {
