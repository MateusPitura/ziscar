...
export const RESOURCES_VALUES = [
  Resources.USERS,
  Resources.VEHICLES,
  Resources.STORES,
  Resources.VEHICLE_PURCHASE,
  Resources.VEHICLE_EXPENSE,
  Resources.VEHICLE_SALE,
...
export const VEHICLECATEGORY_VALUES = [
  VehicleCategory.CAR,
...
export const VEHICLESTATUS_VALUES = [
...
export const EXPENSECATEGORY_VALUES = [
  ExpenseCategory.IPVA,
  ExpenseCategory.MAINTENANCE,
  ExpenseCategory.FUEL,
  ExpenseCategory.FINE,
  ExpenseCategory.LICENSING,
  ExpenseCategory.INSURANCE,
  ExpenseCategory.AGENCY_FEES,
  ExpenseCategory.LOGISTICS,
  ExpenseCategory.OTHER,
] as const;
export const INSTALLMENTSTATUS_VALUES = [
  InstallmentStatus.PAID,
  InstallmentStatus.PENDING,
] as const;
export const PAYMENTMETHODRECEIVABLETYPE_VALUES = [
...
export const PAYMENTMETHODPAYABLETYPE_VALUES = [
  PaymentMethodPayableType.PIX,
  PaymentMethodPayableType.BANK_SLIP,
  PaymentMethodPayableType.CREDIT_CARD,
  PaymentMethodPayableType.DEBIT_CARD,
  PaymentMethodPayableType.TED,
  PaymentMethodPayableType.DOC,
  PaymentMethodPayableType.CASH,
] as const;
...
export type PaymentMethodReceivableTypeType =
  keyof typeof PaymentMethodReceivableType;
export type PaymentMethodPayableTypeType =
  keyof typeof PaymentMethodPayableType;
